...
/*
This oms component is where I defined all functionalites show, add, update, delete in one place. This is the first idea to display
all in single page same as I had done using Django.
*/

/*
This is for an idea on how ShowData works.
const show = (data) =>{
    ...
    return (
        ...
        <>
            ...
            <div className='omsapp'>
                ...
                <div className='row'>
                    <div className='col'>
                        <form name='omsaddForm' onSubmit={handleAddSubmit}>
                            <h3>
                                Oms
                            </h3>
